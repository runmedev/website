...
const FeatureBox = ({ headline, children }: FeatureBoxProps) => {
  return (
...
const FeatureImage = ({ src }: FeatureImageProps) => {
  return (
    <div className="relative mx-4 bg-white rounded min-h-[200px]">
      {src && <Image fill src={src} className="object-contain px-2 aspect-auto" alt="" />}
    </div>
  );
};
