...
const FeatureBox: React.FC<FeatureBoxProps> = ({ setSelected, selected, section, children }) => {
  return (
    <div
      className={clsx(
...
const FeatureShowcase: React.FC<FeatureShowcaseProps> = ({ feature, className }) => {
...
const Features: React.FC = () => {
  ...
  const [selected, setSelected] = useState<string>(topKey);
